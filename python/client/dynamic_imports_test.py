...
method, request_type, _ = service_client.get_method(
...
service_client = sdk.create_dynamic_service_client(
    "snet", "i3d-video-action-recognition")
request = service_client.message.Input(
...
result = service_client.service.VideoActionRecognition.service.video_action_recon(
    request)
